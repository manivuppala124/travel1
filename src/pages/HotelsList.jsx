            ...
            <div className="w-full relative">
              ...
              <Input
                ...
                handleChangeInline={(e) => setFilterParams(prevState => ({
                  ...
                  nights: Number(moment(new Date(e.target.value)).diff(moment(new Date(filterParams.checkin)), 'days')),
                }))}
                  ...
                  >
                    <p className="font-semibold flex items-center text-sm">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 010-9.9zM10 11a2 2 100-4 2 2 000 4z" clipRule="evenodd" />
                      </svg>
                      View On Map
                    </p>
                  </button>
